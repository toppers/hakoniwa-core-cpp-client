...
extern int hako_client_create_pdu_lchannel(const char* robo_name, HakoPduChannelIdType channel_id, size_t pdu_size);
extern int hako_client_pdu_is_dirty(const char* asset_name, const char* robo_name, HakoPduChannelIdType channel_id);
extern int hako_client_write_pdu(const char* asset_name, const char* robo_name, HakoPduChannelIdType channel_id, const char *pdu_data, size_t len);
extern int hako_client_read_pdu(const char* asset_name, const char* robo_name, HakoPduChannelIdType channel_id, char *pdu_data, size_t len);
